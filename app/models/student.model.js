                                                                        ...
                                                                        db.query("SELECT Counter FROM counter", (err, counterRes) => {
                                                                            ...
                                                                            db.query("INSERT INTO student SET ?", newStudent, (err, res) => {
                                                                                ...
                                                                                Payment.create = (newPayment, result) => {
                                                                                    newStudent.id = newPayment.studId;
                                                                                    db.query("INSERT INTO payment SET ?", newPayment, (err, res) => {
                                                                                        if (err) {
                                                                                            console.log("Error during payment: ", err);
                                                                                            result(err, null);
                                                                                            return;
                                                                                        }
                                                                                        console.log("Payment: ", { id: res.payId, ...newPayment });
                                                                                        result(null, { id: res.payId, ...newPayment });
                                                                                    });
                                                                                };
